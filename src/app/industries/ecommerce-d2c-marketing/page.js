  ...
  return (
    <main>
      ...
      <section className="lg:px-24 lg:py-12 p-7">
        <h1 className="text-[90px] lg:text-[160px] mango text-center uppercase leading-24 lg:leading-34 lg:px-40 mb-5">
          Ecommerce & D2C Brands
        </h1>
        <div className="lg:p-12 bg-sky-100 w-full p-5">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-10 items-center">
            <table className="bg-white border border-gray-200 rounded-xl shadow-md mb-16 lg:w-8/10 mt-5">
            ...
            <video className="w-[250px] -mt-32 lg:-mt-0 mb-4 lg:mb-0" playsInline autoPlay loop>
      ...
      />
      <div className="bg-indigo-300 lg:m-16  lg:p-12 p-7 m-7">
        <section className="flex flex-col lg:flex-row lg:items-center lg:py-16 border-b border-blue-400 gap-6 justify-center mb-12 ">
          ...
          <div className="space-y-5 bg-indigo-100 lg:p-12 p-7 lg:w-5/12">
            <p className="text-xl">
